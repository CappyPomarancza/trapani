    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "size-8 sm:size-7 bg-transparent p-0 opacity-50 hover:opacity-100 absolute left-1",
        ),
        button_next: cn(
          buttonVariants({ variant: "outline" }),
          "size-8 sm:size-7 bg-transparent p-0 opacity-50 hover:opacity-100 absolute right-1",
        ),
        month_grid: "w-full border-collapse",
        weekdays: "flex",
        weekday: "text-muted-foreground rounded-md w-9 sm:w-8 font-normal text-xs sm:text-[0.8rem]",
        ...
        day_button: cn(
          ...
          "size-9 sm:size-8 p-0 font-normal aria-selected:opacity-100 text-sm rounded-lg",
        ),
